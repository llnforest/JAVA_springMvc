layui.define('element',function(exports){
	 ...
	 Tab.prototype.set = function (options) {
	   ...
	   * @param data
	   */
	 Tab.prototype.addTab = function(data,refresh){
	      ...
	      if (tabIndex === -1) {
	    	  var content = '<iframe  src="' + data.href + '" data-id="' + data.menuId + '"></iframe>';
			  var titleStr = '';
            ...
            ELEM.contentBox.find('iframe[data-id=' + data.menuId + ']').each(function () {
	    	  ...
	    	  //切换到当前打开的选项卡
	            element.tabChange(ELEM.tabFilter, data.menuId);
	            if(refresh){
	            	ELEM.contentBox.find('iframe[data-id=' + data.menuId + ']')[0].src = data.href;
	            }
