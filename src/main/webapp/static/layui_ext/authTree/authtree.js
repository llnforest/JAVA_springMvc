		...
		*/
		...
		renderAuth: function(tree, dept, opt){
			...
			layui.each(tree, function(index, item){
				...
				(hasChild?'<i class="layui-icon auth-icon '+(openstatus?'active':'')+'" style="cursor:pointer;">'+(openstatus?obj.openIconContent:obj.closeIconContent)+'</i>':'<i class="layui-icon auth-leaf" style="opacity:0;color: transparent;width:16px;">&#xe626;</i>')+
