...
<tiles:putAttribute name="detailDataUrl" value="/system/role/editauth"></tiles:putAttribute>
<tiles:putAttribute name="formBody">
<input type="hidden" name="roleId" value="${roleId}" />
<input type="hidden" name="newMenus" value="" class="newMenus"/>
...
<script>
layui.config({
	base: '/static/layui_ext/authTree/',
}).extend({
	authtree: 'authtree',
});
