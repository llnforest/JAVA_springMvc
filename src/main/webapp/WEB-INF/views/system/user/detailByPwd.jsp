...
<tiles:putAttribute name="detailDataUrl" value="/system/user/activePwdExpire"></tiles:putAttribute>
...
<input type="hidden" name="checkIds" value="${roleIds}" class="checkIds"/>
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="text" name="userDate" value="${userExpDate}"  placeholder="请选择截止日期" class="layui-input layui-disabled" readonly id="userExpDate" readonly>
    </div>
  </div>
  <div class="layui-form-item">
    <label class="layui-form-label">密码有效期</label>
    <div class="layui-input-block">
      <input type="text" name="pwdDate" value="${pwdExpDate}"  placeholder="请选择截止日期" class="layui-input layui-border-color-green" readonly id="pwdExpDate">
    </div>
  </div>
  <div class="layui-form-item">
