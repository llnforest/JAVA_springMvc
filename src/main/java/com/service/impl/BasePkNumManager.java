 ...
 * 2017年4月27日  
 */
@Service("pknumservice")
public class BasePkNumManager implements BasePkNumService{
	
	protected SysLogger log = new SysLogger(this);
	@Autowired
	protected BaseDao<BaseModel, Integer> baseDao;

	
	public BasePkNumManager(){
	...
	@Override
	@SuppressWarnings("all")
	public List<BaseModel> getModelByIds(Class clazz,Integer[] ids) {
		try {
