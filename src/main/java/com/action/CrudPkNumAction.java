 ...
 * 2017年8月24日  
 */
public class CrudPkNumAction<T extends BasePkNumService,M extends BaseModel> extends BasePkNumAction<T,M>{
    ...
    @ResponseBody
	public ResponseModel delete(@PathVariable(value="id") Integer id){
		try {
